...
function fetchPage(page) {
    ...
    const selector = `#userslist tbody`;
    fetch(`/api/users/list?page=${page}`)
        ...
        .then(function (json) {
            ...
            for (let user of json.data) {
                ...
                addTableData(tr, user.username, true);
                addTableData(tr, user.language);
                addTableData(tr, user.firstlogin);
                addTableData(tr, user.lastlogout);
